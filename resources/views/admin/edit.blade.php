...
<div class="x-body layui-anim layui-anim-up">
    <form class="layui-form" id="art_form" action="" method="post">
...
{{--        设置隐藏域--}}
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="{{$goods->name}}" id="L_email" name="name" required=""
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                ...
                {{--                           autocomplete="off" class="layui-input">--}}
                <input type="text" value="{{$goods->date}}" autocomplete="off" name="date" class="layui-input" id="test1" >
            </div>
        </div>
        <div class="layui-form-item">
            <label for="L_username" class="layui-form-label" style="width: 130px">
            ...
            <div class="layui-input-inline">
                ...
                {{--                           autocomplete="off" class="layui-input">--}}
                <textarea name="text" placeholder="请输入内容" class="layui-textarea">{{$goods->text}}</textarea>                </div>
        </div>
        <div class="layui-form-item">
            <label for="L_username" class="layui-form-label" style="width: 130px">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_username" value="{{$goods->place}}" name="place" required="" lay-verify="nikename"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" >
                <img src="../../{{$goods->picture}}" id="art_thumb_img"  style="width: 50%">
