...
<div class="login layui-anim layui-anim-up">
    ...
    <form method="" class=" layui-form "  action="">
        ...
        <input name="goods_name" value="{{$data['goods']->goods_name}}" autocomplete="off" placeholder="商品名称" type="text" lay-verify="required"  class="layui-input" >
        ...
        <div class="layui-input-inline" style="width: 100%">
            <textarea name="goods_introduction" placeholder="请输入商品介绍" class="layui-textarea">
                {{$data['goods']->goods_introduction}}

            </textarea>
        </div>
        <hr class="hr15">
        <input name="goods_price" value="{{$data['goods']->goods_price}}" autocomplete="off" placeholder="商品单价" type="text" lay-verify="required"  class="layui-input" >

        <hr class="hr15">
        <input name="goods_picture"  value="{{$data['goods']->goods_picture}}" autocomplete="off" placeholder="上传图片" type="text" lay-verify="required"  class="layui-input" >
